...
def simulate_elisa_data(seed=42):
    ...
    # 8-point standard curve: 32 ng/mL, 2-fold serial dilution (0.5)
    ...
    # 12 data columns total: STD (2) + A1..A4 (8) + blank + control (2)
...
def build_workbook(output_path, wanted_od="OD(550)"):
    ...
    #Meaningless headers above actual data
    ...
    # Color-scale heatmap on the OD data block
